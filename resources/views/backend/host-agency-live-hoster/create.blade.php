                    ...
                    <form id="formDiv" name="formDiv">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="hoster_name" class="form-control" id="hoster_name" placeholder="Hoster Name">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="hoster_id" class="form-control" id="hoster_id" placeholder="Hoster Id">
        ...
        $('document').ready(function ()
        {
            ...
            $('#saveBtn').click(function (e)
            {
                ...
                $.ajax({
                    ...
                    url: "{{ route('host-agency-live-hoster-store') }}",
                    type: "POST",
                    dataType: 'json',
