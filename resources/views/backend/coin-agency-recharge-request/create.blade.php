...
@section('title', 'Add Recharge Request')
                    ...
                    <form id="formDiv" name="formDiv">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="amount" class="form-control" id="amount" placeholder="Recharge Amount">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="payment_type" class="form-control" id="payment_type" placeholder="Payment Type">
        ...
        $('document').ready(function ()
        {
            ...
            $('#saveBtn').click(function (e)
            {
                ...
                $.ajax({
                    ...
                    url: "{{ route('coin-agency-recharge-store') }}",
                    type: "POST",
                    dataType: 'json',
