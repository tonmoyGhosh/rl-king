...
@section('title', 'Add Coin Send Request')
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div class="d-flex flex-row-reverse">
                    <a href="{{ route('coin-agency-coin-send-list') }}" class="btn btn-sm btn-pill btn-outline-primary font-weight-bolder" id="createNewUser">
                    <i class="fas fa-users"></i>Coin Send Transaction List</a>
                </div>
            </div>
                    ...
                    <form id="formDiv" name="formDiv">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" name="coin" class="form-control" id="coin" placeholder="Coin">
                        ...
                        <div class="modal-footer">
                            <a href="{{ route('coin-agency-coin-send-list') }}" type="button" class="btn btn-light-primary font-weight-bold">Close</a>
        ...
        $('document').ready(function ()
        {
            ...
            $('#saveBtn').click(function (e)
            {
                ...
                $.ajax({
                    ...
                    url: "{{ route('coin-agency-coin-send-store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data)
                    {
                        ...
                        else if(data.status == true)
                        {
                            ...
                            window.setTimeout( function(){
                                window.location = "{{ route('coin-agency-coin-send-list') }}"
                            }, 100 )
                        }
