...
<div class="container h-100" id="outbound_receive">
                <!--begin::Dashboard-->
                <!--begin::Row-->
                <div class="row">
                    ...
                    <div class="col-xl-12 mb-5 mb-xl-10" >
                        ...
                        <div class="card card-flush h-xl-100" id="ELEMENT11">
                            <!--begin::Header-->
                            <div class="card-header pt-7 mb-3">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder text-gray-800">Outbound Content Played <br> by Stakeholder</span>
                                ...
                                <div class="card-toolbar">
                                    <ul class="nav align-items-center">
                                        ...
                                        <li>
                                            <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary h-auto" id="BTN11">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between pb-5 px-0" >
                                ...
                                <ul class="nav nav-pills nav-pills-custom mb-3 mx-9 flex-nowrap overflow-auto">
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        ...
                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_2" href="#kt_charts_widget_32_tab_content_2">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Student/ Parents</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_4" href="#kt_charts_widget_32_tab_content_4">
                                            <!--begin::Icon-->
                                            <div class="nav-icon mb-3">
                                            <span class="svg-icon svg-icon-gray svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="nav-text text-gray-800 fw-bolder fs-6 lh-1">Teachers</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        ...
                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_3" href="#kt_charts_widget_32_tab_content_3">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="nav-text text-gray-800 fw-bolder fs-6 lh-1"> Staff </span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_5" href="#kt_charts_widget_32_tab_content_5">
                                            <!--begin::Icon-->
                                            <div class="nav-icon mb-3">
                                            <span class="svg-icon svg-icon-gray svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <span class="nav-text text-gray-800 fw-bolder fs-6 lh-1"> Govt. officials</span>
                                            <!--end::Title-->
                                            <!--begin::Bullet-->
                                            <span class="bullet-custom position-absolute bottom-0 w-100 h-4px bg-primary"></span>
                                            <!--end::Bullet-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6">
                                        <!--begin::Link-->
                                        <a class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2" data-bs-toggle="pill" id="kt_charts_widget_32_tab_6" href="#kt_charts_widget_32_tab_content_6">
                                            <!--begin::Icon-->
                                            <div class="nav-icon mb-3">
                                            <span class="svg-icon svg-icon-gray svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Group.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div class="tab-content ps-4 pe-6">
                                    ...
                                    <div class="tab-pane fade active show" id="kt_charts_widget_32_tab_content_1">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla">0</span> <br>                                        
                                    ...
                                    <div class="tab-pane fade" id="kt_charts_widget_32_tab_content_2">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla_student">0</span> <br>                                        
                                        <span class="fs-5 fw-bold text-gray-600">Total Calls</span><br>
                                    </div>
                                        <!--begin::Chart-->
                                    ...
                                    <div class="tab-pane fade" id="kt_charts_widget_32_tab_content_3">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla_staff">0</span> <br>                                        
                                        <span class="fs-5 fw-bold text-gray-600">Total Calls</span><br>
                                    </div>
                                        <!--begin::Chart-->
                                    ...
                                    <!--end::Tap pane-->
                                    <!--begin::Tap pane-->
                                    <div class="tab-pane fade" id="kt_charts_widget_32_tab_content_4">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla_teacher">0</span> <br>                                        
                                        <span class="fs-5 fw-bold text-gray-600">Total Calls</span><br>
                                    </div>
                                        <!--begin::Chart-->
                                        <div id="kt_charts_widget_32_chart_4" class="min-h-auto" style="height: 375px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tap pane-->
                                    <!--begin::Tap pane-->
                                    <div class="tab-pane fade" id="kt_charts_widget_32_tab_content_5">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla_govt">0</span> <br>                                        
                                        <span class="fs-5 fw-bold text-gray-600">Total Calls</span><br>
                                    </div>
                                        <!--begin::Chart-->
                                        <div id="kt_charts_widget_32_chart_5" class="min-h-auto" style="height: 375px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tap pane-->
                                    <!--begin::Tap pane-->
                                    <div class="tab-pane fade" id="kt_charts_widget_32_tab_content_6">
                                        <div class="ps-4 pt-3">
                                        <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2" id="Outbound_all_totla_Unspecified">0</span> <br>                                        
                                        <span class="fs-5 fw-bold text-gray-600">Total Calls</span><br>
                                    </div>
                                        <!--begin::Chart-->
                                        <div id="kt_charts_widget_32_chart_6" class="min-h-auto" style="height: 375px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tap pane-->
                                </div>
