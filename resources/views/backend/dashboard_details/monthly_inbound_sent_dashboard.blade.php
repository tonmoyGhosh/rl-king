...
<div class="container h-100" id="inbound_send">
                <!--begin::Dashboard-->
                <!--begin::Row-->
                <div class="row">
                <div class="col-xxl-12 mb-5 mb-xl-10">
                    ...
                    {{--    kt_charts_widget_17_chart_2    --}}
                    <div class="col-xl-12 mb-5 mb-xl-10"  >
                        <!--begin::Chart widget 17-->
                        <div class="card card-flush h-xl-100" id="ELEMENT7">
                            <!--begin::Header-->
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder text-dark">Total Number of Inbound Calls (Received)
                                    <br>    
                                    by Stakeholder </span>
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="card-toolbar">
                                        <ul class="nav align-items-center">
                                            ...
                                            <li>
                                        <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary h-auto" id="BTN7">
                            ...
                            <div class="card-body pt-5">
                                <!--begin::Statistics-->
                                    <div class="mb-2">
                                        <!--begin::Statistics-->
                                        <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="inboundContentPlaybyCategory">0</span>
                                ...
                                <div id="kt_charts_widget_18_chart" class="w-100 h-400px"></div>
                                <!--end::Chart container-->
                            </div>
                            <!--end::Body-->
                        </div>
