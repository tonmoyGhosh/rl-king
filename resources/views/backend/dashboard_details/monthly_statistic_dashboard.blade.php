...
@section('content')
            <div class="container h-100" id="statistics">
                <!--begin::Dashboard-->
                <!--begin::Row-->
                <div class="row">
                <div class="col-xxl-12 mb-5 mb-xl-10">
                    ...
                    <div class="col-xxl-12 mb-5 mb-xl-10">
                        <!--begin::Chart widget 13-->
                        <div class="card card-flush h-md-100" id="ELEMENT1">
                            <!--begin::Header-->
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder text-dark">Monthly Statistics</span>
                                ...
                                <div class="card-toolbar">
                                    <ul class="nav align-items-center" id="kt_chart_widget_13_tabs">
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4 me-1 " data-bs-toggle="tab" id="kt_chart_widget_13_tab_1" href="#kt_chart_widget_13_tab_content_1">INBOUND</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4 me-1 active" data-bs-toggle="tab" id="kt_chart_widget_13_tab_2" href="#kt_chart_widget_13_tab_content_2">OUTBOUND</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bolder px-4 me-1" data-bs-toggle="tab" id="kt_chart_widget_13_tab_3" href="#kt_chart_widget_13_tab_content_3">SMS</a> 
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <button class="btn btn-icon btn-color-gray-400 btn-active-color-primary h-auto" id="BTN1">
                            ...
                            <div class="card-body pb-0 pt-4" >
                                ...
                                <div class="tab-content">
                                    <!--begin::Tab pane-->
                                    <div class="tab-pane fade ELEMENT1" id="kt_chart_widget_13_tab_content_1" role="tabpanel">
                                        <!--begin::Statistics-->
                                        <div class="d-flex">
                                            <div class="mb-2 me-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="Avarage_inbound_call_total" >0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                                <span class="fs-6 fw-bold text-gray-600">Total Inbound Calls</span>
                                                <!--end::Description-->
                                            </div>
                                            <div class="mb-2 ms-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="inbound_target_audience" >0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                        ...
                                        <!--end::Statistics-->
                                        <!--begin::Chart-->
                                        <div id="kt_chart_widget_13_chart_1" class="ms-n5 me-n3 min-h-auto w-100" style="height: 300px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tab pane-->
                                    <!--begin::Tab pane-->
                                    <div class="tab-pane fade active ELEMENT1 show" id="kt_chart_widget_13_tab_content_2" role="tabpanel">
                                        <!--begin::Statistics-->
                                        <div class="d-flex">
                                            <div class="mb-2 me-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="Avarage_outbound_call_total">0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                                <span class="fs-6 fw-bold text-gray-600">Total Outbound Calls</span>
                                                <!--end::Description-->
                                            </div>
                                            <div class="mb-2 ms-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="outbound_target_audience">0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                                <span class="fs-5 fw-bold text-gray-600">Target Audience</span><br>
                                                <!--end::Description-->
                                        ...
                                        <!--end::Statistics-->
                                        <!--begin::Chart-->
                                        <div id="kt_chart_widget_13_chart_2" class="ms-n5 me-n3 min-h-auto" style="height: 300px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tab pane-->
                                    <div class="tab-pane fade ELEMENT1" id="kt_chart_widget_13_tab_content_3" role="tabpanel">
                                        <!--begin::Statistics-->
                                        <div class="d-flex">
                                            <div class="mb-2 me-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="Avarage_sms_total">0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                                <span class="fs-6 fw-bold text-gray-600">Total Campaign Sms</span>
                                                <!--end::Description-->
                                            </div>
                                            <div class="mb-2 ms-5">
                                                <!--begin::Statistics-->
                                                <span class="fs-2hx fw-bolder d-block text-gray-800 me-2 mb-2 lh-1 ls-n2" id="sms_target_audience">0</span>
                                                <!--end::Statistics-->
                                                <!--begin::Description-->
                                                <span class="fs-5 fw-bold text-gray-600">Target Audience</span> <br>
                                                <!--end::Description-->
                                        ...
                                        <!--end::Statistics-->
                                        <!--begin::Chart-->
                                        <div id="kt_chart_widget_13_chart_3" class="ms-n5 me-n3 min-h-auto" style="height: 300px"></div>
                                        <!--end::Chart-->
                                    </div>
                                    <!--end::Tab pane-->
                                </div>
